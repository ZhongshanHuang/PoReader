...
extension String {
    ...
    func pageRanges(attributes: [NSAttributedString.Key: Any], constraintSize: CGSize) -> [NSRange] {
        var results = [NSRange]()
...
//        let costSecs = Date().timeIntervalSince(date)
//        debugPrint("page cost seconds: \(costSecs)")
        return results
    }
